    ...
    var ReaddirGlob = class extends EventEmitter {
      constructor(cwd, options, cb) {
        ...
        if (cb) {
          ...
          this.on("match", (match) =>
            this._matches.push(
              this.options.absolute ? match.absolute : match.relative,
            ),
          );
  ...
  "node_modules/async/dist/async.js"(exports2, module2) {
    (function (global2, factory) {
      ...
      function consoleFunc(name) {
        return (fn, ...args2) =>
          wrapAsync(fn)(...args2, (err, ...resultArgs) => {
  ...
  "node_modules/readable-stream/lib/ours/errors.js"(exports2, module2) {
    ...
    E(
      ...
      (...args2) => {
        ...
        args2 = (Array.isArray(args2) ? args2 : [args2])
          .map((a) => `"${a}"`)
          .join(" or ");
        switch (len) {
          case 1:
...
var require_abort_controller = __commonJS({
  "node_modules/abort-controller/dist/abort-controller.js"(exports2, module2) {
    ...
    module2.exports.AbortController = module2.exports["default"] =
      AbortController;
...
var require_util2 = __commonJS({
  "node_modules/readable-stream/lib/ours/util.js"(exports2, module2) {
    ...
    var AbortSignal =
      globalThis.AbortSignal || require_abort_controller().AbortSignal;
    var AbortController =
      globalThis.AbortController || require_abort_controller().AbortController;
    ...
    module2.exports.promisify.custom = /* @__PURE__ */ Symbol.for(
...
var require_utils = __commonJS({
  "node_modules/readable-stream/lib/internal/streams/utils.js"(
    ...
    "use strict";
    var { SymbolAsyncIterator, SymbolIterator, SymbolFor } =
      require_primordials();
    ...
    var kControllerErrorFunction = SymbolFor(
    ...
    function eos(stream, options, callback) {
      ...
      if (options.signal && !closed) {
        ...
        if (options.signal.aborted) {
          ...
          addAbortListener =
            addAbortListener || require_util2().addAbortListener;
...
var require_destroy2 = __commonJS({
  "node_modules/readable-stream/lib/internal/streams/destroy.js"(
    ...
    var { kIsDestroyed, isDestroyed, isFinished, isServerRequest } =
      require_utils();
    ...
    function destroy(err, cb) {
      ...
      const s = w || r;
      if (
        (w !== null && w !== void 0 && w.destroyed) ||
        (r !== null && r !== void 0 && r.destroyed)
      ) {
        if (typeof cb === "function") {
          cb();
        }
    ...
    function emitCloseNT(self2) {
      ...
      if (
        (w !== null && w !== void 0 && w.emitClose) ||
        (r !== null && r !== void 0 && r.emitClose)
      ) {
        self2.emit("close");
      }
    }
    function emitErrorNT(self2, err) {
      ...
      if (
        ...
        (r !== null && r !== void 0 && r.errorEmitted)
      ) {
        return;
      }
      if (w) {
    ...
    function errorOrDestroy(stream, err, sync) {
      ...
      if (
        (r !== null && r !== void 0 && r.autoDestroy) ||
        (w !== null && w !== void 0 && w.autoDestroy)
      )
        stream.destroy(err);
      else if (err) {
        err.stack;
    ...
    function isRequest(stream) {
      return (
        (stream === null || stream === void 0 ? void 0 : stream.setHeader) &&
...
var require_add_abort_signal = __commonJS({
  "node_modules/readable-stream/lib/internal/streams/add-abort-signal.js"(
    ...
    var { AbortError, codes } = require_errors();
    var { isNodeStream, isWebStream, kControllerErrorFunction } =
      require_utils();
...
var require_readable2 = __commonJS({
  "node_modules/readable-stream/lib/internal/streams/readable.js"(
    ...
    Readable.prototype[SymbolAsyncDispose] = function () {
      ...
      return new Promise2((resolve2, reject) =>
        eos(this, (err) =>
          err && err !== error ? reject(err) : resolve2(null),
        ),
      );
    };
    Readable.prototype.push = function (chunk, encoding) {
      ...
      for (let i = 0; i < streams.length; i++) {
        ...
        if (i === 0) {
          ...
          if (isTransformStream(ret)) {
            var _ret;
            ret = makeAsyncIterable(
              (_ret = ret) === null || _ret === void 0 ? void 0 : _ret.readable,
            );
          } else {
          ...
          if (reading) {
            ...
            const then =
              (_ret2 = ret) === null || _ret2 === void 0 ? void 0 : _ret2.then;
            if (typeof then === "function") {
              finishCount++;
              then.call(
                ret,
...
var require_operators = __commonJS({
  "node_modules/readable-stream/lib/internal/streams/operators.js"(
    ...
    var kResistStopPropagation = require_primordials().Symbol(
      "kResistStopPropagation",
    );
    ...
    var AST = class _AST {
      ...
      push(...parts) {
        for (const p of parts) {
          ...
          if (
            typeof p !== "string" &&
            !(p instanceof _AST && p.#parent === this)
          ) {
...
var require_commonjs = __commonJS({
  "node_modules/minimatch/dist/commonjs/index.js"(exports2) {
    ...
    exports2.sep =
      defaultPlatform === "win32" ? path2.win32.sep : path2.posix.sep;
    ...
    var filter =
      (pattern, options = {}) =>
      (p) =>
        (0, exports2.minimatch)(p, pattern, options);
    ...
    var Minimatch = class {
      ...
      parse(pattern) {
        (0, assert_valid_pattern_js_1.assertValidPattern)(pattern);
        const options = this.options;
        if (pattern === "**") return exports2.GLOBSTAR;
        if (pattern === "") return "";
        let m;
        let fastTest = null;
    ...
    Object.defineProperty(exports2, "AST", {
      enumerable: true,
      get: function () {
        return ast_js_2.AST;
      },
    ...
    Object.defineProperty(exports2, "unescape", {
      enumerable: true,
      get: function () {
...
var require_commonjs4 = __commonJS({
  "node_modules/path-scurry/dist/commonjs/index.js"(exports2) {
    ...
    exports2.PathScurry =
      exports2.Path =
      exports2.PathScurryDarwin =
      exports2.PathScurryPosix =
      exports2.PathScurryWin32 =
      exports2.PathScurryBase =
      exports2.PathPosix =
      exports2.PathWin32 =
      exports2.PathBase =
      exports2.ChildrenCache =
      exports2.ResolveCache =
        void 0;
    ...
    var PathScurryBase = class {
      ...
      constructor(
        ...
        pathImpl,
        sep,
        { nocase, childrenCacheSize = 16 * 1024, fs: fs2 = defaultFS } = {},
      ) {
    ...
    var Ignore = class {
      ...
      ignored(p) {
        ...
        for (const m of this.relative) {
          if (m.match(relative3) || m.match(relatives)) return true;
        }
      ...
      childrenIgnored(p) {
        ...
        for (const m of this.relativeChildren) {
          if (m.match(relative3)) return true;
        }
...
var require_processor = __commonJS({
  "node_modules/glob/dist/commonjs/processor.js"(exports2) {
    ...
    exports2.Processor =
      exports2.SubWalks =
      exports2.MatchRecord =
      exports2.HasWalkedCache =
        void 0;
    var minimatch_1 = require_commonjs();
    var HasWalkedCache = class _HasWalkedCache {
      ...
      storeWalked(target, pattern) {
        ...
        if (cached) cached.add(pattern.globString());
          ...
          this.store.set(
            fullpath,
            /* @__PURE__ */ new Set([pattern.globString()]),
          );
      }
    };
    ...
    var Processor = class _Processor {
      ...
      processPatterns(target, patterns) {
        ...
        for (let [t, pattern] of processingSet) {
          ...
          if (root) {
            t = t.resolve(
              root === "/" && this.opts.root !== void 0 ? this.opts.root : root,
            );
  ...
  "node_modules/glob/dist/commonjs/walker.js"(exports2) {
    ...
    var GlobUtil = class {
      ...
      matchFinish(e, absolute) {
        ...
        const abs =
          this.opts.absolute === void 0 ? absolute : this.opts.absolute;
        this.seen.add(e);
      ...
      walkCB2(target, patterns, processor, cb) {
        ...
        for (const t of processor.subwalkTargets()) {
          ...
          if (t.calledReaddir())
            ...
            t.readdirCB(
              (_2, entries) => this.walkCB3(t, entries, processor, next),
              true,
            );
          }
        }
...
var require_commonjs5 = __commonJS({
  "node_modules/glob/dist/commonjs/index.js"(exports2) {
    ...
    Object.defineProperty(exports2, "Glob", {
      enumerable: true,
      get: function () {
    ...
    Object.defineProperty(exports2, "hasMagic", {
      enumerable: true,
      get: function () {
    ...
    var ignore_js_1 = require_ignore();
    Object.defineProperty(exports2, "Ignore", {
      enumerable: true,
      get: function () {
  ...
  "node_modules/archiver/lib/core.js"(exports2, module2) {
    ...
    Archiver.prototype._updateQueueTaskWithStats = function (task, stats) {
      if (stats.isFile()) {
        ...
        task.data.linkname = path2.relative(
          dirName,
          path2.resolve(dirName, linkPath),
        );
        task.data.sourceType = "buffer";
        task.source = Buffer.concat([]);
      } else {
        if (stats.isDirectory()) {
          ...
          this.emit(
            "warning",
            new ArchiverError("ENTRYNOTSUPPORTED", task.data),
          );
        }
        return null;
      }
...
var require_archive_output_stream = __commonJS({
  "node_modules/compress-commons/lib/archivers/archive-output-stream.js"(
    ...
    ArchiveOutputStream.prototype._appendBuffer = function (
      zae,
      source,
      callback,
    ) {};
    ArchiveOutputStream.prototype._appendStream = function (
      zae,
      source,
      callback,
    ) {};
  ...
  "node_modules/compress-commons/lib/archivers/zip/zip-archive-output-stream.js"(
    ...
    ZipArchiveOutputStream.prototype._appendBuffer = function (
      ...
      if (method === constants.METHOD_STORED) {
        ...
        callback(
          new Error("compression method " + method + " not implemented"),
        );
        return;
      }
    };
    ...
    ZipArchiveOutputStream.prototype._writeCentralFileHeader = function (ae) {
      ...
      this.write(
        zipUtil.getShortBytes(
          (ae.getPlatform() << 8) | constants.VERSION_MADEBY,
        ),
      );
...
var require_zip_stream = __commonJS({
  "node_modules/zip-stream/index.js"(exports2, module2) {
    ...
    var ZipArchiveOutputStream =
      require_compress_commons().ZipArchiveOutputStream;
...
var require_streamx = __commonJS({
  "node_modules/streamx/index.js"(exports2, module2) {
    ...
    var WRITE_UPDATE_SYNC_STATUS =
      WRITE_UPDATING | OPEN_STATUS | WRITE_NEXT_TICK | WRITE_PRIMARY;
    var WRITE_DROP_DATA = WRITE_FINISHING | WRITE_DONE | DESTROY_STATUS;
    var asyncIterator =
      Symbol.asyncIterator || /* @__PURE__ */ Symbol("asyncIterator");
    ...
    var ReadableState = class {
      ...
      updateCallback() {
        if (
          (this.stream._duplexState & READ_UPDATE_SYNC_STATUS) ===
          READ_PRIMARY
        )
          this.update();
        else this.updateNextTick();
...
var require_headers = __commonJS({
  "node_modules/tar-stream/headers.js"(exports2) {
    ...
    exports2.decode = function decode(
      buf,
      filenameEncoding,
      allowUnknownFormat,
    ) {
    ...
    function isUSTAR(buf) {
      return b4a.equals(
        USTAR_MAGIC,
        buf.subarray(MAGIC_OFFSET, MAGIC_OFFSET + 6),
      );
    }
    function isGNU(buf) {
      return (
...
var require_archiver = __commonJS({
  "node_modules/archiver/index.js"(exports2, module2) {
    ...
    vending.registerFormat = function (format, module3) {
      ...
      if (
        typeof module3.prototype.append !== "function" ||
        typeof module3.prototype.finalize !== "function"
      ) {
        throw new Error(
          "register(" + format + "): format module missing methods",
        );
      }
...
var api_base_url = removeAnthropicPath(
...
var updateDeploySettings = (newSettings) => {
  try {
    (0, import_fs.mkdirSync)(
      (0, import_path2.join)(
        process.cwd(),
        (0, import_path2.dirname)(settingsFile),
      ),
      { recursive: true },
    );
    const settingsString = JSON.stringify(newSettings);
    (0, import_fs.writeFileSync)(
      (0, import_path2.join)(process.cwd(), settingsFile),
      settingsString,
      "utf-8",
    );
  } catch (error) {
...
var switchEndpoint = (deploySettings, currentEndpoint) => {
  ...
  if (deploySettings.projectId) {
    const historyItem = {
      ...
      createTime:
        deploySettings.createTime || /* @__PURE__ */ new Date().toISOString(),
  ...
  try {
    ...
    try {
      deploySettings = JSON.parse(
        (0, import_fs.readFileSync)(settingsPath, "utf-8"),
      );
    } catch (error) {
    ...
    deploySettings = switchEndpoint(deploySettings, api_base_url);
...
async function zipFiles(targetFile, files) {
  return new Promise((resolve2, reject) => {
    ...
    output.on("close", () => {
      resolve2(
        new File(
          [(0, import_fs.readFileSync)(targetFile)],
          (0, import_path2.basename)(targetFile),
    ...
    for (const filePath of files) {
      if ((0, import_fs.existsSync)(filePath)) {
        const relativePath = (0, import_path2.relative)(
          process.cwd(),
          filePath,
        );
...
async function deploy(ignoreFilePath, extraParam) {
  ...
  try {
    ...
    const files = await filterDirectoryFiles(
      localFolder,
      ignoreFilePath,
      !!outdir ? [outdir] : [],
    );
    ...
    try {
      ...
      const uploadParams = await getUploadParamsForDeploy(
    ...
    while (pollAttempts < maxPollAttempts) {
      try {
        const statusResult = await getDeployStatus(projectId, deployId);
  ...
  try {
    switch (command) {
      case "deploy": {
        ...
        if (result.projectId) {
          console.info("\u{1F4CD} ProjectId:", result.projectId);
        }
        if (result.deployId) {
          console.info("\u{1F4CD} DeployId:", result.deployId);
        }
        if (result.status) {
